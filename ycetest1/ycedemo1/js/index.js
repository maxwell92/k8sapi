    ...
    function ajax(pageType){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data.yeepay,function(i,val){
                    
                        ohtml += "<tr><td><a href='#'>"+val.appHealthz.podsAvailable+"</a></td><td class='tables-tds'><p><span>"+val.appName+"</span></p><p><span>"+val.appLabel.appversion+"</span></p></td><td>"+val.appDatacenter+"</td><td>"+val.appReplicas+"</td><td>"+val.appWorktime+"</td><td><span>更多</span></td></tr>";
